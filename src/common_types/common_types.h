...
#define STIM_CONFIG_HASH_FOR_INIT_FUNCTIONS(d)                                                                                                                 \
    do {                                                                                                                                                       \
        for(int64_t i__ = 0; i__ < hmlen(d); i__++) {                                                                                                          \
            struct string_voidp_hash_entry e = (d)[i__];                                                                                                       \
            init_config_functions((struct config*)e.value, (char*)"./shared_libs/libdefault_stimuli.so", (char*)e.key);                                                                      \
        }                                                                                                                                                      \
    } while(0)
...
#define MODIFY_DOMAIN_CONFIG_HASH_FOR_INIT_FUNCTIONS(d)                                                                                                        \
    do {                                                                                                                                                       \
        for(int64_t __i = 0; __i < hmlen(d); __i++) {                                                                                                          \
            ...
            init_config_functions((struct config*)e__.value, (char*)"./shared_libs/libdefault_modify_domain.so", (char*)e__.key);                                                            \
        }                                                                                                                                                      \
    } while(0)
